...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-02-2024 a las 14:51:43
...
CREATE TABLE `agents` (
  ...
  `agent_lastname` varchar(500) NOT NULL,
  `agent_identification` varchar(10) NOT NULL,
  `agent_rif` varchar(11) NOT NULL,
  `agent_gender` int(11) NOT NULL,
  `agent_type` int(11) NOT NULL,
  `agent_number_type` int(11) NOT NULL,
  `agent_telefone` int(11) NOT NULL,
  `agent_telefone_alternative` int(11) NOT NULL,
  `agent_email` varchar(500) NOT NULL,
  `agent_email_alternative` varchar(500) NOT NULL,
  `agent_number` varchar(500) NOT NULL,
  `agent_date_inscription` date NOT NULL,
  `agent_management` tinyint(1) NOT NULL,
...
(1, 'Marcas'),
(2, 'Patentes'),
(3, 'Indicaciones Geograficas');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `areas_has_agents`
--

CREATE TABLE `areas_has_agents` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `direcction`
--

CREATE TABLE `direcction` (
  `id` int(11) NOT NULL,
  `direcction_name` varchar(500) NOT NULL,
  `direcction_estado` int(11) NOT NULL,
  `direcction_municipio` int(11) NOT NULL,
  `direcction_parroquia` int(11) NOT NULL,
  `direcction_lat` varchar(500) NOT NULL,
  `direcction_lng` varchar(500) NOT NULL,
  `direcction_id_agent` int(11) NOT NULL,
  `created` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `municipios` (
  ...
  `id_hidrologica` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `municipios` (`id_municipio`, `id_estado`, `municipio`, `id_hidrologica`) VALUES
(1, 1, 'Alto Orinoco', 10),
(2, 1, 'Atabapo', 10),
(3, 1, 'Atures', 10),
(4, 1, 'Autana', 10),
...
(8, 2, 'Anaco', 14),
(9, 2, 'Aragua', 14),
(10, 2, 'Manuel Ezequiel Bruzual', 14),
(11, 2, 'Diego Bautista Urbaneja', 14),
(12, 2, 'Fernando Peñalver', 14),
(13, 2, 'Francisco Del Carmen Carvajal', 14),
(14, 2, 'General Sir Arthur McGregor', 14),
(15, 2, 'Guanta', 14),
(16, 2, 'Independencia', 14),
(17, 2, 'José Gregorio Monagas', 14),
(18, 2, 'Juan Antonio Sotillo', 14),
(19, 2, 'Juan Manuel Cajigal', 14),
(20, 2, 'Libertad', 14),
(21, 2, 'Francisco de Miranda', 14),
(22, 2, 'Pedro María Freites', 14),
(23, 2, 'Píritu', 14),
(24, 2, 'San José de Guanipa', 14),
(25, 2, 'San Juan de Capistrano', 14),
(26, 2, 'Santa Ana', 14),
(27, 2, 'Simón Bolívar', 14),
(28, 2, 'Simón Rodríguez', 14),
(29, 3, 'Achaguas', 4),
(30, 3, 'Biruaca', 4),
(31, 3, 'Muñóz', 4),
(32, 3, 'Páez', 4),
(33, 3, 'Pedro Camejo', 4),
(34, 3, 'Rómulo Gallegos', 4),
(35, 3, 'San Fernando', 4),
(36, 4, 'Atanasio Girardot', 15),
(37, 4, 'Bolívar', 15),
(38, 4, 'Camatagua', 15),
(39, 4, 'Francisco Linares Alcántara', 15),
(40, 4, 'José Ángel Lamas', 15),
(41, 4, 'José Félix Ribas', 15),
(42, 4, 'José Rafael Revenga', 15),
(43, 4, 'Libertador', 15),
(44, 4, 'Mario Briceño Iragorry', 15),
(45, 4, 'Ocumare de la Costa de Oro', 15),
(46, 4, 'San Casimiro', 15),
(47, 4, 'San Sebastián', 15),
(48, 4, 'Santiago Mariño', 15),
(49, 4, 'Santos Michelena', 15),
(50, 4, 'Sucre', 15),
(51, 4, 'Tovar', 15),
(52, 4, 'Urdaneta', 15),
(53, 4, 'Zamora', 15),
(54, 5, 'Alberto Arvelo Torrealba', 13),
(55, 5, 'Andrés Eloy Blanco', 13),
(56, 5, 'Antonio José de Sucre', 13),
(57, 5, 'Arismendi', 13),
(58, 5, 'Barinas', 13),
(59, 5, 'Bolívar', 13),
(60, 5, 'Cruz Paredes', 13),
(61, 5, 'Ezequiel Zamora', 13),
(62, 5, 'Obispos', 13),
(63, 5, 'Pedraza', 13),
(64, 5, 'Rojas', 13),
(65, 5, 'Sosa', 13),
...
(70, 6, 'Heres', 11),
(71, 6, 'Piar', 11),
(72, 6, 'Angostura (Raúl Leoni)', 11),
(73, 6, 'Roscio', 11),
(74, 6, 'Sifontes', 11),
(75, 6, 'Sucre', 11),
(76, 6, 'Padre Pedro Chien', 11),
(77, 7, 'Bejuma', 15),
(78, 7, 'Carlos Arvelo', 15),
(79, 7, 'Diego Ibarra', 15),
(80, 7, 'Guacara', 15),
(81, 7, 'Juan José Mora', 15),
(82, 7, 'Libertador', 15),
(83, 7, 'Los Guayos', 15),
(84, 7, 'Miranda', 15),
(85, 7, 'Montalbán', 15),
(86, 7, 'Naguanagua', 15),
(87, 7, 'Puerto Cabello', 15),
(88, 7, 'San Diego', 15),
(89, 7, 'San Joaquín', 15),
(90, 7, 'Valencia', 15),
(91, 8, 'Anzoátegui', 15),
...
(93, 8, 'Girardot', 15),
(94, 8, 'Lima Blanco', 15),
(95, 8, 'Pao de San Juan Bautista', 15),
(96, 8, 'Ricaurte', 15),
(97, 8, 'Rómulo Gallegos', 15),
(98, 8, 'San Carlos', 15),
(99, 8, 'Tinaco', 15),
(100, 9, 'Antonio Díaz', 12),
(101, 9, 'Casacoima', 12),
(102, 9, 'Pedernales', 12),
(103, 9, 'Tucupita', 12),
(104, 10, 'Acosta', 16),
(105, 10, 'Bolívar', 16),
(106, 10, 'Buchivacoa', 16),
(107, 10, 'Cacique Manaure', 16),
(108, 10, 'Carirubana', 16),
(109, 10, 'Colina', 16),
(110, 10, 'Dabajuro', 16),
(111, 10, 'Democracia', 16),
(112, 10, 'Falcón', 16),
(113, 10, 'Federación', 16),
(114, 10, 'Jacura', 16),
(115, 10, 'José Laurencio Silva', 16),
(116, 10, 'Los Taques', 16),
(117, 10, 'Mauroa', 16),
(118, 10, 'Miranda', 16),
(119, 10, 'Monseñor Iturriza', 16),
(120, 10, 'Palmasola', 16),
(121, 10, 'Petit', 16),
(122, 10, 'Píritu', 16),
(123, 10, 'San Francisco', 16),
(124, 10, 'Sucre', 16),
(125, 10, 'Tocópero', 16),
(126, 10, 'Unión', 16),
(127, 10, 'Urumaco', 16),
(128, 10, 'Zamora', 16),
(129, 11, 'Camaguán', 17),
(130, 11, 'Chaguaramas', 17),
(131, 11, 'El Socorro', 17),
(132, 11, 'José Félix Ribas', 17),
(133, 11, 'José Tadeo Monagas', 17),
(134, 11, 'Juan Germán Roscio', 17),
(135, 11, 'Julián Mellado', 17),
(136, 11, 'Las Mercedes', 17),
(137, 11, 'Leonardo Infante', 17),
(138, 11, 'Pedro Zaraza', 17),
(139, 11, 'Ortíz', 17),
(140, 11, 'San Gerónimo de Guayabal', 17),
(141, 11, 'San José de Guaribe', 17),
(142, 11, 'Santa María de Ipire', 17),
(143, 11, 'Sebastián Francisco de Miranda', 17),
(144, 12, 'Andrés Eloy Blanco', 9),
(145, 12, 'Crespo', 9),
(146, 12, 'Iribarren', 9),
(147, 12, 'Jiménez', 9),
(148, 12, 'Morán', 9),
(149, 12, 'Palavecino', 9),
(150, 12, 'Simón Planas', 9),
(151, 12, 'Torres', 9),
(152, 12, 'Urdaneta', 9),
(179, 13, 'Alberto Adriani', 3),
(180, 13, 'Andrés Bello', 3),
(181, 13, 'Antonio Pinto Salinas', 3),
(182, 13, 'Aricagua', 3),
(183, 13, 'Arzobispo Chacón', 3),
(184, 13, 'Campo Elías', 3),
(185, 13, 'Caracciolo Parra Olmedo', 3),
(186, 13, 'Cardenal Quintero', 3),
(187, 13, 'Guaraque', 3),
(188, 13, 'Julio César Salas', 3),
(189, 13, 'Justo Briceño', 3),
(190, 13, 'Libertador', 3),
(191, 13, 'Miranda', 3),
(192, 13, 'Obispo Ramos de Lora', 3),
(193, 13, 'Padre Noguera', 3),
(194, 13, 'Pueblo Llano', 3),
(195, 13, 'Rangel', 3),
(196, 13, 'Rivas Dávila', 3),
(197, 13, 'Santos Marquina', 3),
(198, 13, 'Sucre', 3),
(199, 13, 'Tovar', 3),
(200, 13, 'Tulio Febres Cordero', 3),
(201, 13, 'Zea', 3),
(223, 14, 'Acevedo', 1),
...
(261, 15, 'Caripe', 5),
(262, 15, 'Cedeño', 5),
(263, 15, 'Ezequiel Zamora', 5),
(264, 15, 'Libertador', 5),
(265, 15, 'Maturín', 5),
(266, 15, 'Piar', 5),
(267, 15, 'Punceres', 5),
(268, 15, 'Santa Bárbara', 5),
(269, 15, 'Sotillo', 5),
(270, 15, 'Uracoa', 5),
(271, 16, 'Antolín del Campo', 14),
(272, 16, 'Arismendi', 14),
(273, 16, 'García', 14),
(274, 16, 'Gómez', 14),
(275, 16, 'Maneiro', 14),
(276, 16, 'Marcano', 14),
(277, 16, 'Mariño', 14),
(278, 16, 'Península de Macanao', 14),
(279, 16, 'Tubores', 14),
(280, 16, 'Villalba', 14),
(281, 16, 'Díaz', 14),
(282, 17, 'Agua Blanca', 18),
(283, 17, 'Araure', 18),
(284, 17, 'Esteller', 18),
(285, 17, 'Guanare', 18),
(286, 17, 'Guanarito', 18),
(287, 17, 'Monseñor José Vicente de Unda', 18),
(288, 17, 'Ospino', 18),
(289, 17, 'Páez', 18),
(290, 17, 'Papelón', 18),
(291, 17, 'San Genaro de Boconoíto', 18),
(292, 17, 'San Rafael de Onoto', 18),
(293, 17, 'Santa Rosalía', 18),
(294, 17, 'Sucre', 18),
(295, 17, 'Turén', 18),
(296, 18, 'Andrés Eloy Blanco', 14),
(297, 18, 'Andrés Mata', 0),
(298, 18, 'Arismendi', 14),
(299, 18, 'Benítez', 14),
(300, 18, 'Bermúdez', 14),
(301, 18, 'Bolívar', 14),
(302, 18, 'Cajigal', 14),
(303, 18, 'Cruz Salmerón Acosta', 14),
(304, 18, 'Libertador', 14),
(305, 18, 'Mariño', 14),
(306, 18, 'Mejía', 14),
(307, 18, 'Montes', 14),
(308, 18, 'Ribero', 14),
(309, 18, 'Sucre', 14),
(310, 18, 'Valdéz', 14),
(341, 19, 'Andrés Bello', 19),
(342, 19, 'Antonio Rómulo Costa', 19),
(343, 19, 'Ayacucho', 19),
(344, 19, 'Bolívar', 19),
(345, 19, 'Cárdenas', 19),
(346, 19, 'Córdoba', 19),
(347, 19, 'Fernández Feo', 19),
(348, 19, 'Francisco de Miranda', 19),
(349, 19, 'García de Hevia', 19),
(350, 19, 'Guásimos', 19),
(351, 19, 'Independencia', 19),
(352, 19, 'Jáuregui', 19),
(353, 19, 'José María Vargas', 19),
(354, 19, 'Junín', 19),
(355, 19, 'Libertad', 19),
(356, 19, 'Libertador', 19),
(357, 19, 'Lobatera', 19),
(358, 19, 'Michelena', 19),
(359, 19, 'Panamericano', 19),
(360, 19, 'Pedro María Ureña', 19),
(361, 19, 'Rafael Urdaneta', 19),
(362, 19, 'Samuel Darío Maldonado', 19),
(363, 19, 'San Cristóbal', 19),
(364, 19, 'Seboruco', 19),
(365, 19, 'Simón Rodríguez', 19),
(366, 19, 'Sucre', 19),
(367, 19, 'Torbes', 19),
(368, 19, 'Uribante', 19),
(369, 19, 'San Judas Tadeo', 19),
(370, 20, 'Andrés Bello', 13),
(371, 20, 'Boconó', 13),
(372, 20, 'Bolívar', 13),
(373, 20, 'Candelaria', 13),
(374, 20, 'Carache', 13),
(375, 20, 'Escuque', 13),
(376, 20, 'José Felipe Márquez Cañizalez', 13),
(377, 20, 'Juan Vicente Campos Elías', 13),
(378, 20, 'La Ceiba', 13),
(379, 20, 'Miranda', 13),
(380, 20, 'Monte Carmelo', 13),
(381, 20, 'Motatán', 13),
(382, 20, 'Pampán', 13),
(383, 20, 'Pampanito', 13),
(384, 20, 'Rafael Rangel', 13),
(385, 20, 'San Rafael de Carvajal', 13),
(386, 20, 'Sucre', 13),
(387, 20, 'Trujillo', 13),
(388, 20, 'Urdaneta', 13),
(389, 20, 'Valera', 13),
(390, 21, 'Vargas', 1),
(391, 22, 'Arístides Bastidas', 8),
(392, 22, 'Bolívar', 8),
(407, 22, 'Bruzual', 8),
(408, 22, 'Cocorote', 8),
(409, 22, 'Independencia', 8),
(410, 22, 'José Antonio Páez', 8),
(411, 22, 'La Trinidad', 8),
(412, 22, 'Manuel Monge', 8),
(413, 22, 'Nirgua', 8),
(414, 22, 'Peña', 8),
(415, 22, 'San Felipe', 8),
(416, 22, 'Sucre', 8),
(417, 22, 'Urachiche', 8),
(418, 22, 'José Joaquín Veroes', 8),
(441, 23, 'Almirante Padilla', 2),
(442, 23, 'Baralt', 2),
(443, 23, 'Cabimas', 2),
(444, 23, 'Catatumbo', 2),
(445, 23, 'Colón', 2),
(446, 23, 'Francisco Javier Pulgar', 2),
(447, 23, 'Páez', 2),
(448, 23, 'Jesús Enrique Losada', 2),
(449, 23, 'Jesús María Semprún', 2),
(450, 23, 'La Cañada de Urdaneta', 2),
(451, 23, 'Lagunillas', 2),
(452, 23, 'Machiques de Perijá', 2),
(453, 23, 'Mara', 2),
(454, 23, 'Maracaibo', 2),
(455, 23, 'Miranda', 2),
(456, 23, 'Rosario de Perijá', 2),
(457, 23, 'San Francisco', 2),
(458, 23, 'Santa Rita', 2),
(459, 23, 'Simón Bolívar', 2),
(460, 23, 'Sucre', 2),
(461, 23, 'Valmore Rodríguez', 2),
(462, 24, 'Libertador', 1);
...
CREATE TABLE `parroquias` (
  ...
  `id_municipio` int(11) NOT NULL,
  `parroquia` varchar(250) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `signature` (
  `id` int(11) NOT NULL,
  `signature_name` varchar(500) NOT NULL,
  `signature_identification` varchar(15) NOT NULL,
  `signature_direcction` varchar(500) NOT NULL,
  `signature_telefone` int(11) NOT NULL,
  `signature_alternative_telefone` int(11) NOT NULL,
  `signature_email` varchar(300) NOT NULL,
  `signature_alternative_email` varchar(300) NOT NULL,
...
--
-- Estructura de tabla para la tabla `signature_has_agents`
--

CREATE TABLE `signature_has_agents` (
  `id` int(11) NOT NULL,
  `id_agent` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `type_agent`
--

CREATE TABLE `type_agent` (
  `id` int(11) NOT NULL,
  `type_agent_name` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `type_agent`
--

INSERT INTO `type_agent` (`id`, `type_agent_name`) VALUES
(1, 'Abogado'),
(2, 'Economista');
...
CREATE TABLE `type_files` (
  `id` int(11) NOT NULL,
  `type_file_name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `type_files` (`id`, `type_file_name`) VALUES
(1, 'Rif'),
(2, 'Foto Agente'),
(3, 'Cedula'),
(4, 'Tipo'),
...
ALTER TABLE `agents`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `agent_identification` (`agent_identification`),
  ADD UNIQUE KEY `agent_rif` (`agent_rif`),
...
--
-- Indices de la tabla `areas_has_agents`
--
ALTER TABLE `areas_has_agents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_agent` (`id_agent`),
  ADD KEY `id_area` (`id_area`);

--
-- Indices de la tabla `direcction`
--
ALTER TABLE `direcction`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `direcction_id_agent` (`direcction_id_agent`);
...
ALTER TABLE `files`
  ADD PRIMARY KEY (`id`),
  ADD KEY `file_id_agent` (`file_id_agent`);
...
ALTER TABLE `municipios`
  ...
  ADD KEY `ID_Hidrologica` (`id_hidrologica`),
...
ALTER TABLE `signature`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `signature_identification` (`signature_identification`);

--
-- Indices de la tabla `signature_has_agents`
--
ALTER TABLE `signature_has_agents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_agent` (`id_agent`),
  ADD KEY `id_signature` (`id_signature`);

--
-- Indices de la tabla `type_agent`
--
...
--
-- AUTO_INCREMENT de la tabla `areas_has_agents`
--
ALTER TABLE `areas_has_agents`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `direcction`
--
ALTER TABLE `direcction`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `signature_has_agents`
--
ALTER TABLE `signature_has_agents`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `type_agent`
--
ALTER TABLE `type_agent`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `agents`
  ADD CONSTRAINT `agents_ibfk_1` FOREIGN KEY (`agent_type`) REFERENCES `type_agent` (`id`);

--
-- Filtros para la tabla `areas_has_agents`
--
ALTER TABLE `areas_has_agents`
  ADD CONSTRAINT `areas_has_agents_ibfk_2` FOREIGN KEY (`id_area`) REFERENCES `areas` (`id`),
  ADD CONSTRAINT `areas_has_agents_ibfk_3` FOREIGN KEY (`id_agent`) REFERENCES `agents` (`id`);

--
-- Filtros para la tabla `direcction`
--
ALTER TABLE `direcction`
  ADD CONSTRAINT `direcction_ibfk_1` FOREIGN KEY (`direcction_id_agent`) REFERENCES `agents` (`id`);

--
-- Filtros para la tabla `files`
--
ALTER TABLE `files`
  ADD CONSTRAINT `files_ibfk_1` FOREIGN KEY (`file_id_agent`) REFERENCES `agents` (`id`);
...
--
-- Filtros para la tabla `signature_has_agents`
--
ALTER TABLE `signature_has_agents`
  ADD CONSTRAINT `signature_has_agents_ibfk_1` FOREIGN KEY (`id_signature`) REFERENCES `signature` (`id`),
  ADD CONSTRAINT `signature_has_agents_ibfk_2` FOREIGN KEY (`id_agent`) REFERENCES `agents` (`id`);
COMMIT;
