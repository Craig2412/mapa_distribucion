...
--
-- Estructura de tabla para la tabla `datos_generales_empresa`
--

CREATE TABLE `datos_generales_empresa` (
  `id` int(11) NOT NULL,
  `razon_social` text NOT NULL,
  `coordenadas_x` varchar(500) NOT NULL,
  `coordenadas_y` varchar(500) NOT NULL,
...
--
-- Volcado de datos para la tabla `datos_generales_empresa`
--

INSERT INTO `datos_generales_empresa` (`id`, `razon_social`, `coordenadas_x`, `coordenadas_y`, `rif`, `id_estado`, `id_municipio`, `id_parroquia`, `id_representante_legal`, `telefono`, `correo`, `sector`, `sub_sector`) VALUES
(1, 'Nombre Empresa', 'coordenadas_x', 'coordenadas_y', 'rif', 1, 2, 3, 1, 0, 'correo@gmail.com', 'sector', 'sub_sector'),
(2, 'NOMBRE EMPRESA', 'COORDENADAS_X', 'coordenadas_y', 'RIF', 1, 2, 3, 1, 4127008592, 'CORREO@GMAIL.COM', 'sector', 'SUB_SECTOR');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `datos_mayoristas`
--

CREATE TABLE `datos_mayoristas` (
  `id` int(11) NOT NULL,
  `id_datos_generales` int(11) NOT NULL,
  `id_tipo_mayorista` int(11) NOT NULL,
  `cantidad_locales_comerciales` int(11) NOT NULL,
  `capacidad_almacenamiento` int(11) NOT NULL,
  `capacidad_almacenamiento_frio` int(11) NOT NULL,
  `tamaño_infraestructura` int(11) NOT NULL,
  `precio_volumen` float NOT NULL,
  `frecuencia_reposicion` varchar(50) NOT NULL,
  `cantidad_trabajadores_directos` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `datos_mayoristas`
--
...
--
-- Estructura de tabla para la tabla `datos_representante_legal`
--

CREATE TABLE `datos_representante_legal` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `datos_representante_legal`
--

INSERT INTO `datos_representante_legal` (`id`, `nombres`, `apellidos`, `identificacion`, `correo`, `telefono`) VALUES
(1, 'Nombre 1 y 2', 'Apellido 1 y 2', 0, 'correo@gmail.com', 4127008592),
(2, 'NOMBRE 1 Y 2', 'APELLIDO 1 Y 2', 0, 'CORREO@GMAIL.COM', 4127008592),
(3, 'NOMBRE 1 Y 2', 'APELLIDO 1 Y 2', 0, 'CORREO@GMAIL.COM', 4127008592),
(4, 'NOMBRE 1 Y 2', 'APELLIDO 1 Y 2', 0, 'CORREO@GMAIL.COM', 4127008592),
(5, 'NOMBRE 1 Y 2', 'APELLIDO 1 Y 2', 0, 'CORREO@GMAIL.COM', 4127008592);
...
--
-- Estructura de tabla para la tabla `formas_movilizacion_mercancia`
--

CREATE TABLE `formas_movilizacion_mercancia` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `origenes_producto`
--

CREATE TABLE `origenes_producto` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `origen_rubro_mayorista`
--

CREATE TABLE `origen_rubro_mayorista` (
  `id` int(11) NOT NULL,
  `id_mayorista` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `tipos_mayoristas`
--
...
--
-- Estructura de tabla para la tabla `tipos_movilizacion`
--
...
INSERT INTO `tipos_movilizacion` (`id`, `tipo_movilizacion`) VALUES
(1, 'Vehicular');
...
--
-- Indices de la tabla `datos_generales_empresa`
--
...
--
-- Indices de la tabla `datos_mayoristas`
--
ALTER TABLE `datos_mayoristas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_datos_generales` (`id_datos_generales`),
  ADD KEY `id_tipo_mayorista` (`id_tipo_mayorista`);

--
-- Indices de la tabla `datos_representante_legal`
--
...
--
-- Indices de la tabla `formas_movilizacion_mercancia`
--
ALTER TABLE `formas_movilizacion_mercancia`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_tipo_movilizacion` (`id_tipo_movilizacion`),
...
--
-- Indices de la tabla `origenes_producto`
--
ALTER TABLE `origenes_producto`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `origen_rubro_mayorista`
--
ALTER TABLE `origen_rubro_mayorista`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_mayorista` (`id_mayorista`),
...
--
-- Indices de la tabla `tipos_mayoristas`
--
ALTER TABLE `tipos_mayoristas`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tipos_movilizacion`
--
ALTER TABLE `tipos_movilizacion`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `formas_movilizacion_mercancia`
--
ALTER TABLE `formas_movilizacion_mercancia`
...
--
-- AUTO_INCREMENT de la tabla `origen_rubro_mayorista`
--
ALTER TABLE `origen_rubro_mayorista`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `datos_generales_empresa`
--
ALTER TABLE `datos_generales_empresa`
  ADD CONSTRAINT `datos_generales_empresa_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id`),
  ADD CONSTRAINT `datos_generales_empresa_ibfk_2` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id`),
  ADD CONSTRAINT `datos_generales_empresa_ibfk_3` FOREIGN KEY (`id_parroquia`) REFERENCES `parroquias` (`id`),
  ADD CONSTRAINT `datos_generales_empresa_ibfk_4` FOREIGN KEY (`id_representante_legal`) REFERENCES `datos_representante_legal` (`id`);

--
-- Filtros para la tabla `datos_mayoristas`
--
ALTER TABLE `datos_mayoristas`
  ADD CONSTRAINT `datos_mayoristas_ibfk_1` FOREIGN KEY (`id_datos_generales`) REFERENCES `datos_generales_empresa` (`id`),
  ADD CONSTRAINT `datos_mayoristas_ibfk_2` FOREIGN KEY (`id_tipo_mayorista`) REFERENCES `tipos_mayoristas` (`id`);

--
-- Filtros para la tabla `formas_movilizacion_mercancia`
--
ALTER TABLE `formas_movilizacion_mercancia`
  ADD CONSTRAINT `formas_movilizacion_mercancia_ibfk_1` FOREIGN KEY (`id_mayorista`) REFERENCES `datos_mayoristas` (`id`),
...
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `municipios_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `origen_rubro_mayorista`
--
ALTER TABLE `origen_rubro_mayorista`
  ADD CONSTRAINT `origen_rubro_mayorista_ibfk_1` FOREIGN KEY (`id_rubro`) REFERENCES `rubros` (`id`),
  ADD CONSTRAINT `origen_rubro_mayorista_ibfk_2` FOREIGN KEY (`id_origen`) REFERENCES `origenes_producto` (`id`),
  ADD CONSTRAINT `origen_rubro_mayorista_ibfk_3` FOREIGN KEY (`id_mayorista`) REFERENCES `datos_mayoristas` (`id`);

--
-- Filtros para la tabla `parroquias`
--
ALTER TABLE `parroquias`
  ADD CONSTRAINT `parroquias_ibfk_1` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
