...
INSERT INTO `ciudades` (`id`, `id_estado`, `ciudad`, `capital`) VALUES
(1, 1, 'Maroa', 0),
...
--
ALTER TABLE `ciudades`
  ADD CONSTRAINT `ciudades_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
