...
final class FuncionariosRepository
{
    ...
    public function getFuncionariosById(int $funcionariosId, $type): array
    {
    ...
    {
        $updated = !empty($funcionarios['updated']) ? $funcionarios['updated'] : null;
        $responsable = !empty($funcionarios['responsable']) ? $funcionarios['responsable'] : "0";
        $serial_carnet = !empty($funcionarios['serial_carnet']) ? strtoupper($funcionarios['serial_carnet']) : "0";
        $codigo_carnet = !empty($funcionarios['codigo_carnet']) ? strtoupper($funcionarios['codigo_carnet']) : "0";
        $correo = !empty($funcionarios['correo']) ? strtoupper($funcionarios['correo']) : "x@x.com";
        $telefono = !empty($funcionarios['telefono']) ? strtoupper($funcionarios['telefono']) : "0";
        return [
            ...
            'departamento' => strtoupper($funcionarios['departamento']),
            'entidad_principal' => strtoupper($funcionarios['entidad_principal']),
            'entidad_adscripcion' => strtoupper($funcionarios['entidad_adscripcion']),
    ...
    private function toRowUpdate(array $funcionarios): array
    {
        ...
        if (empty($funcionarios['responsable'])) {
