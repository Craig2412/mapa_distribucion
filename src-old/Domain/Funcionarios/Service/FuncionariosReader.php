...
final class FuncionariosReader
{
     ...
     */
    public function getFuncionarios(int $funcionariosId, int $type): FuncionariosReaderResult
    {
        // Input validation
        // ...

        // Fetch data from the database
        $funcionariosRow = $this->repository->getFuncionariosById($funcionariosId, $type);
        ...
        $result->responsable = $funcionariosRow['responsable'];
    ...
    public function getFuncionariosId(int $funcionariosId): FuncionariosReaderResult
    {
        // Input validation
        // ...

        // Fetch data from the database
        $funcionariosRow = $this->repository->getFuncionariosPorId($funcionariosId);
