...
final class FuncionariosByEstatusFinder
{
    ...
    public function findFuncionariosByEstatus($estatusId,$where, $tipo_busqueda): FuncionariosByEstatusFinderResult
    {
        
        // Input validation
        $funcionariosByEstatus = $this->repository->findFuncionariosByEstatus($estatusId,$where, $tipo_busqueda);
